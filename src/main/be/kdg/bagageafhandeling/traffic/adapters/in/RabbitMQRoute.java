 ...
 */
public class RabbitMQRoute extends Observable implements MessageInputService {
    ...
    public RabbitMQRoute(String queueName) {
            ...
            Consumer consumer = new DefaultConsumer(channel) {
                ...
                public void handleDelivery(String consumerTag, Envelope envelope, AMQP.BasicProperties properties, byte[] body)
                    ...
                    try {
                        ...
                        Baggage messageDTO = null;
                        messageDTO = (Baggage) jaxbUnmarshaller.unmarshal(reader);
                        setChanged();
